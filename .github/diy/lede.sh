...
########################################luci-theme-design#############################################
git clone -b https://github.com/gngpp/luci-theme-design.git ./luci-theme-design
git clone -b https://github.com/gngpp/luci-app-design-config.git ./luci-app-design-config
####################################################################################
